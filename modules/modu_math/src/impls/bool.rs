...
impl ScalarBackend<2> for bool {
    ...
    #[inline(always)]
    fn vec_add(_: Self::Vec, _: Self::Vec) -> Self::Vec {
        unreachable!()
    }

    #[inline(always)]
    fn vec_sub(_: Self::Vec, _: Self::Vec) -> Self::Vec {
        unreachable!()
    }

    #[inline(always)]
    fn vec_mul(_: Self::Vec, _: Self::Vec) -> Self::Vec {
        unreachable!()
    }

    #[inline(always)]
    fn vec_div(_: Self::Vec, _: Self::Vec) -> Self::Vec {
        unreachable!()
    }

    #[inline(always)]
    fn vec_rem(_: Self::Vec, _: Self::Vec) -> Self::Vec {
        unreachable!()
    }
